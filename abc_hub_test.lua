...
elseif game.PlaceId == 7449423635 then
    ...
    game:GetService("Players").LocalPlayer:Kick("Hub này đéo hỗ excute này mong bạn sài Fluxus")
end
...
OrionLib:MakeNotification({
	Name = "Skid Hub",
	Content = "Skid Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
if _G.Blackscreen then
    BlackScreen.Size = UDim2.new(500, 0, 500, 500)
else
    BlackScreen.Size = UDim2.new(BlackScreen.Size)
end
    })
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Sid Hub(Noitification)",
                    Content = "[EN] : Please cancel the farrm level quest (if any)",
                    Image = "rbxassetid://4483345998",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "Skid Hub(Noitification)",
